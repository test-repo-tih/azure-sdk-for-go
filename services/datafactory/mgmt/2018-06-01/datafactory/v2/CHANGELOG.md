...
1. *DataFlowListResponseIterator.Next() error
1. *DataFlowListResponseIterator.NextWithContext(context.Context) error
1. *DataFlowListResponsePage.Next() error
1. *DataFlowListResponsePage.NextWithContext(context.Context) error
...
1. *OperationListResponseIterator.Next() error
1. *OperationListResponseIterator.NextWithContext(context.Context) error
1. *OperationListResponsePage.Next() error
1. *OperationListResponsePage.NextWithContext(context.Context) error
...
1. *QueryDataFlowDebugSessionsResponseIterator.Next() error
1. *QueryDataFlowDebugSessionsResponseIterator.NextWithContext(context.Context) error
1. *QueryDataFlowDebugSessionsResponsePage.Next() error
1. *QueryDataFlowDebugSessionsResponsePage.NextWithContext(context.Context) error
1. *RerunTriggerListResponseIterator.Next() error
1. *RerunTriggerListResponseIterator.NextWithContext(context.Context) error
1. *RerunTriggerListResponsePage.Next() error
1. *RerunTriggerListResponsePage.NextWithContext(context.Context) error
