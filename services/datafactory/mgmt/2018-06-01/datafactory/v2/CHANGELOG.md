...
1. *MySQLLinkedServiceTypeProperties.UnmarshalJSON([]byte) error
1. *PostgreSQLLinkedServiceTypeProperties.UnmarshalJSON([]byte) error
...
1. MySQLLinkedServiceTypeProperties.ConnectionString changed type from BasicSecretBase to interface{}
1. PostgreSQLLinkedServiceTypeProperties.ConnectionString changed type from BasicSecretBase to interface{}
...
1. SsisPackageLocationType.InlinePackage
...
1. SSISPackageLocationTypeProperties.ChildPackages
1. SSISPackageLocationTypeProperties.PackageContent
1. SSISPackageLocationTypeProperties.PackageLastModifiedDate
1. SSISPackageLocationTypeProperties.PackageName
1. WebActivityTypeProperties.ConnectVia
